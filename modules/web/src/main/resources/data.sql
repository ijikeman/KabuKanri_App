...
('3563', 'FOOD & LIFE COMPANIES', 'jp', NULL, NULL, NULL, NULL, 28),
('9434', 'ソフトバンク', 'jp', NULL, NULL, NULL, NULL, 20),
('4765', 'ＳＢＩグローバルアセットマネジメント', 'jp', NULL, NULL, NULL, NULL, 21),
('8473', 'ＳＢＩホールディングス', 'jp', NULL, NULL, NULL, NULL, 29),
('3763', 'プロシップ', 'jp', NULL, NULL, NULL, NULL, 20),
('2193', 'クックパッド', 'jp', NULL, NULL, NULL, NULL, 20),
('3548', 'バロックジャパンリミテッド', 'jp', NULL, NULL, NULL, NULL, 28),
('9201', '日本航空', 'jp', NULL, NULL, NULL, NULL, 25),
...
('6458', '新晃工業', 'jp', NULL, NULL, NULL, NULL, 16),
('8002', '丸紅', 'jp', NULL, NULL, NULL, NULL, 27),
('9757', '船井総研ホールディングス', 'jp', NULL, NULL, NULL, NULL, 21),
('7374', 'コンフィデンス・インターワークス', 'jp', NULL, NULL, NULL, NULL, 21),
('9765', 'オオバ', 'jp', NULL, NULL, NULL, NULL, 21),
...
('2432', 'DeNa', 'jp', NULL, NULL, NULL, NULL, 21),
